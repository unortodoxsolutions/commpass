...
let ActivityPage = class ActivityPage {
    ...
    getVisitors() {
        if (this.role === 'resident' || this.role === 'dependent') {
            firebase_app__WEBPACK_IMPORTED_MODULE_4__["database"]().ref(`${this.role}/${this.uid}`).child('visitors').orderByChild('bookedAt').once('value', (snapshot) => {
                this.visitors = [];
        ...
        if (this.role === 'security') {
            ...
            firebase_app__WEBPACK_IMPORTED_MODULE_4__["database"]().ref(`Estates/${this.profile.estateUID}/visitors`).orderByChild('bookedAt').once('value', (snapshot) => {
                this.visitors = [];
                for (const key in snapshot.val()) {
                    if (snapshot.val().hasOwnProperty(key)) {
                        const visitor = snapshot.val()[key];
...
ActivityPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./activity.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/activity/activity.page.html")).default,
        providers: [_hoa_store_service__WEBPACK_IMPORTED_MODULE_3__["HoaStoreService"]],
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./activity.page.scss */ "./src/app/activity/activity.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_hoa_store_service__WEBPACK_IMPORTED_MODULE_3__["HoaStoreService"],
