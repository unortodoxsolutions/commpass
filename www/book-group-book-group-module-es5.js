...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["book-group-book-group-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppBookGroupBookGroupPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppBookGroupBookGroupModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BookGroupPageModule", function () {
      return BookGroupPageModule;
    });
    /* harmony import */
    ...
    var _book_group_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./book-group.page */
    ...
    var BookGroupPageModule = function BookGroupPageModule() {
      _classCallCheck(this, BookGroupPageModule);
    };

    BookGroupPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppBookGroupBookGroupPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppBookGroupBookGroupPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BookGroupPage", function () {
      return BookGroupPage;
    });
    /* harmony import */
    ...
    var firebase_database__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! firebase/database */
    ...
    /*#__PURE__*/
    function () {
      function BookGroupPage(store, toast, alert, router, socialSharing, geoLocation) {
        _classCallCheck(this, BookGroupPage);
        ...
        this.guestForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"]({
          ...
          'reason': new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required]))
        });
      }

      _createClass(BookGroupPage, [{
        key: "addGuest",
        ...
        key: "bookGroupGuests",
        value: function bookGroupGuests() {
          var _this = this;
          ...
          firebase_app__WEBPACK_IMPORTED_MODULE_9__["database"]().ref("".concat(role, "/").concat(uid)).child('visitors').push(data).then(function (res) {
            console.log('Added to user route successfully'); // ADD GUEST TO GENERAL VISITOR'S NODE FOR SECURITY

            firebase_app__WEBPACK_IMPORTED_MODULE_9__["database"]().ref('Visitors').child(res.key).set(data).then(function () {
              // tslint:disable-next-line:max-line-length
              var presentAlert = _this.alert.presentGroupShareAlert("Share Booking With Guests?", _this.guests, _this.guestCode, _this.profile, _this.location);

              console.log('Added to Visitor\'s route for security');

              _this.router.navigate(['app/activity']);

              _this.toast.showToast('Guests Booked', '2000', 'bottom');
            ...
            firebase_app__WEBPACK_IMPORTED_MODULE_9__["database"]().ref("Estates/".concat(_this.profile.estateUID)).child('visitors').push(res.key).then(function () {
            ...
            if (role === 'dependent') {
              firebase_app__WEBPACK_IMPORTED_MODULE_9__["database"]().ref("resident/".concat(_this.dependentOn.uid, "/dependents/").concat(uid)).child('visitors').push(data).then(function () {
        ...
        value: function getDependentOn() {
          ...
          firebase_app__WEBPACK_IMPORTED_MODULE_9__["database"]().ref("resident/".concat(this.profile.dependentOn)).once('value', function (snapshot) {
            console.log('Retrieved dependentOn');
            _this2.dependentOn = snapshot.val();
          }).catch(function (err) {
            console.error(err.message);
          });
        }
        ...
        value: function getProfile() {
          ...
          firebase_app__WEBPACK_IMPORTED_MODULE_9__["database"]().ref(role).child(uid).once('value', function (snapshot) {
        ...
        value: function ngOnInit() {
          ...
          firebase_app__WEBPACK_IMPORTED_MODULE_9__["database"]().ref('Visitors').once('value', function (snap) {
            if (snap.val()) {
              for (var key in snap.val()) {
                if (snap.val().hasOwnProperty(key)) {
                  var visitor = snap.val()[key];

                  if (visitor.status === 'In' && visitor.guestCode === _this6.guestCode) {
                    console.log('Code exists', _this6.guestCode);
                    _this6.guestCode = Math.floor(Math.random() * (999 - 100 + 1)) + 100;
                  } else {
                    console.log('Code available', _this6.guestCode);
                    _this6.guestCode = Math.floor(Math.random() * (999 - 100 + 1)) + 100;
                  }
                }
              }
              ...
              console.log('No snap');
              _this6.guestCode = Math.floor(Math.random() * (999 - 100 + 1)) + 100;
              console.log('Guest Code', _this6.guestCode);
            }
          });
        }
      }]);
    ...
    BookGroupPage.ctorParameters = function () {
      return [{
    ...
    BookGroupPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-book-group',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./book-group.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/book-group/book-group.page.html")).default,
      ...
      /*! ./book-group.page.scss */
      "./src/app/book-group/book-group.page.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_hoa_store_service__WEBPACK_IMPORTED_MODULE_6__["HoaStoreService"], _toast_service__WEBPACK_IMPORTED_MODULE_7__["ToastService"], _alert_service__WEBPACK_IMPORTED_MODULE_8__["AlertService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _ionic_native_social_sharing_ngx__WEBPACK_IMPORTED_MODULE_4__["SocialSharing"], _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_5__["Geolocation"]])], BookGroupPage);
    /***/
  }
}]);
//# sourceMappingURL=book-group-book-group-module-es5.js.map