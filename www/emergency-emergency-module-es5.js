...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["emergency-emergency-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppEmergencyEmergencyPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppEmergencyEmergencyModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EmergencyPageModule", function () {
    ...
    var _emergency_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./emergency.page */
    ...
    var EmergencyPageModule = function EmergencyPageModule() {
      _classCallCheck(this, EmergencyPageModule);
    };

    EmergencyPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppEmergencyEmergencyPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppEmergencyEmergencyPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EmergencyPage", function () {
    ...
    /*#__PURE__*/
    function () {
      function EmergencyPage(call, store, toast) {
        _classCallCheck(this, EmergencyPage);
      ...
      _createClass(EmergencyPage, [{
        key: "callEstateAuth",
        value: function callEstateAuth() {
          var _this = this;

          // CALL ESTATE AUTHPRITIES
          this.call.isCallSupported().then(function () {
            // ${this.estateDetails.emergencyNumber}
            _this.call.callNumber("+2347050706655", false).then(function (res) {
              console.log(res);

              _this.toast.showToast(res, '2000', 'bottom');

              alert(res);
            }).catch(function (err) {
              console.error(err.message);

              _this.toast.showToast(err.message, '2000', 'bottom');
        ...
        value: function callAuth() {
          ...
          this.call.isCallSupported().then(function () {
            _this2.call.callNumber("+2347050706655", false).then(function (res) {
              console.log(res);

              _this2.toast.showToast(res, '2000', 'bottom');

              alert(res);
            }).catch(function (err) {
              console.error(err.message);

              _this2.toast.showToast(err.message, '2000', 'bottom');
        ...
        value: function getProfile() {
          ...
          firebase_app__WEBPACK_IMPORTED_MODULE_5__["database"]().ref(role).child(uid).once('value', function (snapshot) {
            _this3.profile = snapshot.val();
            _this3.estateDetails = _this3.getEstateDetails(snapshot.val().estateName);
          }).then(function () {
        ...
        key: "getEstateDetails",
        value: function getEstateDetails(estateName) {
          firebase_app__WEBPACK_IMPORTED_MODULE_5__["database"]().ref('Estates').child(estateName).once('value', function (snapshot) {
            return snapshot.val();
          });
        }
      }, {
        key: "ngOnInit",
        value: function ngOnInit() {//   this.getProfile();
        }
      }]);
    ...
    EmergencyPage.ctorParameters = function () {
      return [{
    ...
    EmergencyPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-emergency',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./emergency.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/emergency/emergency.page.html")).default,
      ...
      /*! ./emergency.page.scss */
      "./src/app/emergency/emergency.page.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_call_number_ngx__WEBPACK_IMPORTED_MODULE_2__["CallNumber"], _hoa_store_service__WEBPACK_IMPORTED_MODULE_3__["HoaStoreService"], _toast_service__WEBPACK_IMPORTED_MODULE_4__["ToastService"]])], EmergencyPage);
    /***/
  }
}]);
//# sourceMappingURL=emergency-emergency-module-es5.js.map