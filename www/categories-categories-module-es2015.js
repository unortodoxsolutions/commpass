...
let CategoriesPage = class CategoriesPage {
    ...
    getVisitors() {
        ...
        firebase_app__WEBPACK_IMPORTED_MODULE_4__["database"]().ref('Visitors').orderByChild('bookedAt').once('value', (snapshot) => {
    ...
    getNews() {
        ...
        if (this.role === 'resident' || this.role === 'security') {
            firebase_app__WEBPACK_IMPORTED_MODULE_4__["database"]().ref(`${this.role}/${this.uid}`).child('estateName').once('value', (snapshot) => {
                const estateName = snapshot.val();
                console.log('Estate', snapshot.val());
                firebase_app__WEBPACK_IMPORTED_MODULE_4__["database"]().ref(`Estates/${snapshot.val()}`).child('news').orderByChild('postedAt').on('value', (snap) => {
    ...
    getDependentOn() {
        ...
        firebase_app__WEBPACK_IMPORTED_MODULE_4__["database"]().ref(`resident/${this.profile.dependentOn}`).once('value', (snapshot) => {
            ...
            if (this.role === 'dependent') {
                ...
                firebase_app__WEBPACK_IMPORTED_MODULE_4__["database"]().ref(`resident/${snapshot.val().uid}`).child('estateName').once('value', (snapshot) => {
                    const estateName = snapshot.val();
                    console.log('Estate', snapshot.val());
                    firebase_app__WEBPACK_IMPORTED_MODULE_4__["database"]().ref(`Estates/${estateName}`).child('news').orderByChild('postedAt').on('value', (snap) => {
                        for (const key in snap.val()) {
                            if (snap.val().hasOwnProperty(key)) {
                                const news = snap.val()[key];
                                this.estateNewsKeys.push(key);
    ...
    getProfile() {
        firebase_app__WEBPACK_IMPORTED_MODULE_4__["database"]().ref(`${this.role}/${this.uid}`).once('value', (snapshot) => {
...
CategoriesPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./styles/categories.page.scss */ "./src/app/categories/styles/categories.page.scss")).default, tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./styles/categories.shell.scss */ "./src/app/categories/styles/categories.shell.scss")).default, tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./styles/categories.responsive.scss */ "./src/app/categories/styles/categories.responsive.scss")).default]
    }),
