  ...
  function node_modulesIonicCoreDistEsmIonSlide_2MdEntryJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(Slides, [{
        ...
        value: function componentDidUnload() {
          var swiper;
          return regeneratorRuntime.async(function componentDidUnload$(_context2) {
            while (1) {
        ...
        value: function initSwiper() {
          var finalOptions, _ref, Swiper, swiper;

          return regeneratorRuntime.async(function initSwiper$(_context18) {
            while (1) {
