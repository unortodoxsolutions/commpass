...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["add-dependent-add-dependent-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAddDependentAddDependentPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAddDependentAddDependentModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AddDependentPageModule", function () {
    ...
    var _add_dependent_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./add-dependent.page */
    ...
    var AddDependentPageModule = function AddDependentPageModule() {
      _classCallCheck(this, AddDependentPageModule);
    };

    AddDependentPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["IonicModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild(routes), _components_components_module__WEBPACK_IMPORTED_MODULE_5__["ComponentsModule"]],
  ...
  /***/
  function srcAppAddDependentAddDependentPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAddDependentAddDependentPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AddDependentPage", function () {
    ...
    var AddDependentPage =
    /*#__PURE__*/
    function () {
      function AddDependentPage(router, store) {
        _classCallCheck(this, AddDependentPage);
        ...
        this.validation_messages = {
          ...
          'phone': [{
            type: 'required',
            message: 'Dependent phone number is required'
          }],
          'relationship': [{
            type: 'required',
            message: 'Relationship with dependent is required'
          }],
          'password': [{
            type: 'required',
        ...
        this.uid = this.store.getItem('hoa-uid'); //   INIT FORM

        this.dependentForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
          'accountName': new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])),
          ...
          'relationship': new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])),
      ...
      _createClass(AddDependentPage, [{
        key: "addDependent",
        value: function addDependent(uid) {
          var _this = this;
          ...
          firebase_app__WEBPACK_IMPORTED_MODULE_5__["database"]().ref("".concat(this.role, "/").concat(this.uid)).child('dependents').push(dependent).then(function () {
          ...
          firebase_app__WEBPACK_IMPORTED_MODULE_5__["database"]().ref("dependent/".concat(uid)).set(dependent).then(function () {
        ...
        key: "createDependentAccount",
        value: function createDependentAccount() {
          var _this2 = this;

          this.isLoading = true;
          var email = this.dependentForm.get('email').value;
          var password = this.dependentForm.get('password').value; //    let uid;
          //    CREATE DEPENDENT'S AUTH ACCOUNT

          firebase_app__WEBPACK_IMPORTED_MODULE_5__["auth"]().createUserWithEmailAndPassword(email, password).then(function (res) {
            // uid = res.user.uid;
            _this2.addDependent(res.user.uid);
    ...
    AddDependentPage.ctorParameters = function () {
      return [{
    ...
    AddDependentPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-add-dependent',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./add-dependent.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/add-dependent/add-dependent.page.html")).default,
      providers: [_hoa_store_service__WEBPACK_IMPORTED_MODULE_3__["HoaStoreService"]],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./add-dependent.page.scss */
      "./src/app/add-dependent/add-dependent.page.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _hoa_store_service__WEBPACK_IMPORTED_MODULE_3__["HoaStoreService"]])], AddDependentPage);
    /***/
  }
}]);
//# sourceMappingURL=add-dependent-add-dependent-module-es5.js.map