...
/* harmony import */ var firebase_database__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! firebase/database */ "./node_modules/firebase/database/dist/index.esm.js");
/* harmony import */ var _hoa_store_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../hoa-store.service */ "./src/app/hoa-store.service.ts");
...
let UserProfilePage = class UserProfilePage {
    constructor(route, translate, languageService, alertController, router, store, toast, imagePicker, geolocation, gmaps, geocoder, nativeG) {
        this.route = route;
    ...
    addProfileImg() {
        ...
        this.imagePicker.getPictures(options).then((result) => {
            ...
            const uploadTask = firebase_app__WEBPACK_IMPORTED_MODULE_11__["storage"]().ref(`${this.role}/${this.uid}`).child('profilePic').putString(result);
            uploadTask.on('state_changed', (snapshot) => {
                ...
                switch (snapshot.state) {
                    case firebase_app__WEBPACK_IMPORTED_MODULE_11__["storage"].TaskState.PAUSED: // or 'paused'
                        console.log('Upload is paused');
                        break;
                    case firebase_app__WEBPACK_IMPORTED_MODULE_11__["storage"].TaskState.RUNNING: // or 'running'
                ...
                uploadTask.snapshot.ref.getDownloadURL().then((downloadURL) => {
                    ...
                    firebase_app__WEBPACK_IMPORTED_MODULE_11__["database"]().ref(`${this.role}/${this.uid}`).child('profilePic').set(downloadURL);
    ...
    getLocation() {
        ...
        this.geolocation.getCurrentPosition().then((pos) => {
            ...
            this.nativeG.reverseGeocode(lat, lng, options).then((result) => {
    ...
    getProfile() {
        ...
        firebase_app__WEBPACK_IMPORTED_MODULE_11__["database"]().ref(role).child(uid).once('value', (snapshot) => {
            ...
            this.dependents = [];
            // GET ESTATE NAME
            firebase_app__WEBPACK_IMPORTED_MODULE_11__["database"]().ref('Estates').child(snapshot.val().estateUID).once('value', (estate) => {
    ...
    getDependentOn() {
        firebase_app__WEBPACK_IMPORTED_MODULE_11__["database"]().ref(`resident/${this.profile.dependentOn}`).once('value', (snapshot) => {
...
UserProfilePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"],
        ...
        _hoa_store_service__WEBPACK_IMPORTED_MODULE_14__["HoaStoreService"],
        ...
        _ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_7__["Geocoder"],
