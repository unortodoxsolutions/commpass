...
/* harmony import */ var _hoa_store_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../hoa-store.service */ "./src/app/hoa-store.service.ts");
...
let SignupPage = class SignupPage {
    constructor(router, modalController, menu, store) {
        this.router = router;
        this.modalController = modalController;
        this.menu = menu;
        this.store = store;
        ...
        this.signupForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            ...
            'role': new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required
            ]))
        });
    ...
    doSignup() {
        ...
        firebase__WEBPACK_IMPORTED_MODULE_9__["auth"]().createUserWithEmailAndPassword(email, password).then((res) => {
...
SignupPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"],
        ...
        _hoa_store_service__WEBPACK_IMPORTED_MODULE_8__["HoaStoreService"]])
], SignupPage);
