...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BookGuestPageModule", function() { return BookGuestPageModule; });
...
/* harmony import */ var _book_guest_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./book-guest.page */ "./src/app/book-guest/book-guest.page.ts");
...
let BookGuestPageModule = class BookGuestPageModule {
};
BookGuestPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BookGuestPage", function() { return BookGuestPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
/* harmony import */ var _hoa_store_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../hoa-store.service */ "./src/app/hoa-store.service.ts");
...
let BookGuestPage = class BookGuestPage {
    constructor(router, store, toast, alert, contacts, socialSharing, geoLocation) {
        this.router = router;
        this.store = store;
        this.toast = toast;
        this.alert = alert;
    ...
    bookGuest() {
        ...
        firebase_app__WEBPACK_IMPORTED_MODULE_10__["database"]().ref(`${role}/${uid}`).child('visitors').push(data).then((res) => {
            console.log('Added to user route successfully');
            // ADD GUEST TO GENERAL VISITOR'S NODE FOR SECURITY
            firebase_app__WEBPACK_IMPORTED_MODULE_10__["database"]().ref('Visitors').child(res.key).set(data).then(() => {
            ...
            firebase_app__WEBPACK_IMPORTED_MODULE_10__["database"]().ref(`Estates/${this.profile.estateUID}`).child('visitors').push(res.key).then(() => {
            ...
            if (role === 'dependent') {
                firebase_app__WEBPACK_IMPORTED_MODULE_10__["database"]().ref(`resident/${this.dependentOn.uid}/dependents/${uid}`).child('visitors').push(data).then(() => {
    ...
    getDependentOn() {
        firebase_app__WEBPACK_IMPORTED_MODULE_10__["database"]().ref(`resident/${this.profile.dependentOn}`).once('value', (snapshot) => {
    ...
    getProfile() {
        ...
        firebase_app__WEBPACK_IMPORTED_MODULE_10__["database"]().ref(role).child(uid).once('value', (snapshot) => {
    ...
    ngOnInit() {
        ...
        firebase_app__WEBPACK_IMPORTED_MODULE_10__["database"]().ref('Visitors').once('value', (snap) => {
            if (snap.val()) {
...
BookGuestPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-book-guest',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./book-guest.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/book-guest/book-guest.page.html")).default,
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./book-guest.page.scss */ "./src/app/book-guest/book-guest.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
        _hoa_store_service__WEBPACK_IMPORTED_MODULE_7__["HoaStoreService"],
...
//# sourceMappingURL=book-guest-book-guest-module-es2015.js.map